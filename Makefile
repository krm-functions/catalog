...
BINS ?= apply-setters digester helm-upgrader kubeconform render-helm-chart set-annotations set-labels source-helm-chart package-compositor # template-kyaml
